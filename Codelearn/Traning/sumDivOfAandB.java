  public static int sumDivOfAandB(long n, long a, long b)
  {
  ...
  public static BigInteger sumDivOfA(long a, long n)
  {
      BigInteger b = BigInteger.valueOf(a);
      BigInteger c = BigInteger.valueOf(n);
      BigInteger div = c.divide(b);
      return div.multiply(div.add(BigInteger.ONE)).divide(BigInteger.TWO).multiply(b);
  }
